...
public class DcpPatchExtension implements ServiceExtension {
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        trustedIssuerRegistry.register(new Issuer("did:web:issuerservice.edc-v.svc.cluster.local%3A10016:issuer", Map.of()), WILDCARD); // for the credential used to demo the issuance flow
